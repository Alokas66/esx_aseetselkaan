...
Config.RealWeapons = {
	...
	{name = 'WEAPON_COMBATPDW', 		bone = 24818, x = 0.1, y = -0.15, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'machine', 	model = 'w_sb_pdw'},
	...
	{name = 'WEAPON_CARBINERIFLE_MK2',  bone = 24818, x = 0.1, y = -0.15, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_carbinerifle'},
...
--	{name = 'WEAPON_MICROSMG', 			bone = 24818, x = 0.1, y = -0.15, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'assault', 	model = 'w_sb_microsmg'},
	{name = 'WEAPON_BULLPUPRIFLE_MK2', 	bone = 24818, x = 0.1, y = -0.15, z = 0.1, xRot = 0.0, yRot = 145.0, zRot = 0.0, category = 'assault',  model = 'w_ar_bullpuprifle'},
	{name = 'WEAPON_GUSENBERG',		 	bone = 24818, x = 0.1, y = -0.15, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'sniper', 	model = 'w_sb_gusenberg'},
	{name = 'WEAPON_MUSKET',		 	bone = 24818, x = 0.1, y = -0.15, z = 0.0, xRot = 0.0, yRot = 135.0, zRot = 0.0, category = 'assault', 	model = 'w_ar_musket'},
